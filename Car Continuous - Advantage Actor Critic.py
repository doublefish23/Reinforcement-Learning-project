...
@exec_time
def actor_critic(episodes=1000, gamma=0.95, display=False, lamb=1e-5, policy_lr=0.001, value_lr=0.1):
    ...
    stats = []
    text_file = open("actorcritic2.txt", "w")
    for i_episode in range(episodes):
        ...
        if np.mean(stats[-100:]) > 90 and len(stats) >= 101:
            ...
            print("Solved")
        print("Episode: {}, reward: {}, steps: {}.".format(i_episode, reward_total, t))
        text_file.write("{},{:.2f},{}\r\n".format(i_episode, reward_total, t))
...
if __name__ == "__main__":
    policy_lr, value_lr, lamb, gamma = [0.0001, 0.00046415888336127773, 2.782559402207126e-05, 0.99999999999999999]
    loss = actor_critic(episodes=1000, gamma=gamma, display=True, lamb=lamb, policy_lr=policy_lr, value_lr=value_lr)
    print(-loss)
    env.close()